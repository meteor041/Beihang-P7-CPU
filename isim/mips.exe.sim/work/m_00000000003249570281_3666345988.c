...
LAB20:    t202 = (t0 + 9856);
    ...
    *((unsigned int *)t212) = (t214 | t208);
    xsi_driver_vfirst_trans(t202, 0, 4);
    t215 = (t0 + 9392);
    *((int *)t215) = 1;
...
LAB69:    if (*((unsigned int *)t173) > 0)
        goto LAB70;

LAB71:    if (*((unsigned int *)t111) > 0)
        goto LAB72;

LAB73:    memcpy(t110, t182, 8);

LAB74:    goto LAB42;

LAB43:    xsi_vlog_unsigned_bit_combine(t39, 5, t105, 5, t110, 5);
    goto LAB47;

LAB45:    memcpy(t39, t105, 8);
    goto LAB47;
...
LAB56:    if (*((unsigned int *)t125) != 0)
        goto LAB57;

LAB58:    t135 = *((unsigned int *)t114);
...
LAB82:    if (*((unsigned int *)t192) > 0)
        goto LAB83;

LAB84:    if (*((unsigned int *)t183) > 0)
        goto LAB85;

LAB86:    memcpy(t182, t201, 8);

LAB87:    goto LAB69;

LAB70:    xsi_vlog_unsigned_bit_combine(t110, 5, t177, 5, t182, 5);
    goto LAB74;

LAB72:    memcpy(t110, t177, 8);
    goto LAB74;

LAB75:    *((unsigned int *)t183) = 1;
    goto LAB78;
...
LAB83:    xsi_vlog_unsigned_bit_combine(t182, 5, t196, 5, t201, 5);
    goto LAB87;

LAB85:    memcpy(t182, t196, 8);
    goto LAB87;

}


extern void work_m_00000000003249570281_3666345988_init()
{
	static char *pe[] = {(void *)Cont_77_0,(void *)Cont_79_1,(void *)Cont_89_2,(void *)Cont_90_3,(void *)Cont_95_4,(void *)Cont_115_5,(void *)Cont_116_6};
	xsi_register_didat("work_m_00000000003249570281_3666345988", "isim/mips.exe.sim/work/m_00000000003249570281_3666345988.didat");
